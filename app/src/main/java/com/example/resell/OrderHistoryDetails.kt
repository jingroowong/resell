...
//                    // Create an order details model and associate it with the order and product
//                    val orderDetailsModel = Cart()
//                    orderDetailsModel.productID = product.productID
//                    orderDetailsModel.orderID = orderDetail.orderID
//                    orderDetailsModel.productName = product.productName
//                    orderDetailsModel.productPrice = product.productPrice
//
//                    orderDetailModels.add(orderDetailsModel)
...
//                        getString(R.string.price_format, product.productPrice)
                }
            }
